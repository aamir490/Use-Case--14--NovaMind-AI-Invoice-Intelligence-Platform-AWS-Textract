    ...
    <aside className="w-64 bg-brand-900 text-white flex flex-col shrink-0">
      ...
      <div className="px-6 py-5 border-b border-white/10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold leading-tight">NovaMind</p>
            <p className="text-xs text-brand-100/70 leading-tight">Ai Invoice Intelligence</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-white/10">
        <p className="text-xs text-brand-100/40 text-center">Powered by AWS Bedrock + Textract</p>
        <p className="text-xs text-white/70 font-bold text-center mt-2">Created by Aamir</p>
        <div className="flex justify-center gap-3 mt-1">
          <a href="https://github.com/aamir490" target="_blank" rel="noreferrer"
            className="text-brand-100/50 text-xs underline hover:text-white flex items-center gap-1">
